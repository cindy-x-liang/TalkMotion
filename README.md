...
3. Feel free to customize what each movement says and which word or phrase is matched to each movement by clicking on the “change gesture words” button in settings. To change the words, tap on the phrase next to the drop-down menus, make your change and hit the save changes on the bottom of the screen. To change what movement is mapped to each word, tap on the drop-down menu next to each phrase, select the movement you want to be matched to each word, and hit save changes on the bottom of the screen. 
